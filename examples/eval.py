...
def parse_input_args():
    ...
    parser_eval.add_argument('actionfile', type=str, nargs='?', default='bigdata/misc/actions.h5')
    parser_eval.add_argument('holdoutfile', type=str, nargs='?', default='bigdata/misc/holdout_set.h5')
